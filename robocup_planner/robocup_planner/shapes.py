...
shapes.py
---------
Hardcoded target shapes for the pick and place task.
Add new shapes here as needed.

Each shape is a dict: { "pos_name": (x, y, z) }
These are the positions blocks need to END UP at.
"""
